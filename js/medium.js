...
const mediumTwoCorrectAnswer = document.querySelector(
  "#mediumTwoCorrectAnswer"
);
...
const unloackModalmediumThree = document.querySelector(
  "#unloackModalmediumThree"
);
...
const insertAnswermediumThree = () => {
  ...
  mediumThreeCorrectAnswer.textContent =
    arrQuesMedium.medium3[randomNum].answer;
